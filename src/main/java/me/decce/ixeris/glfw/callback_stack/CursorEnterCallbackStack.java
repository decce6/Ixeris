...
public class CursorEnterCallbackStack {
    private static final Long2ReferenceMap<CursorEnterCallbackStack> instance = Long2ReferenceMaps.synchronize(new Long2ReferenceArrayMap<>(1));
    ...
    public static void forEach(Consumer<CursorEnterCallbackStack> consumer) {
