...
public class WindowMaximizeCallbackStack {
    private static final Long2ReferenceMap<WindowMaximizeCallbackStack> instance = Long2ReferenceMaps.synchronize(new Long2ReferenceOpenHashMap<>(1));
    ...
    public static void forEach(Consumer<WindowMaximizeCallbackStack> consumer) {
