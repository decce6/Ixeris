...
public class ForgeTransformationHelper extends TransformationHelper {
    public ForgeTransformationHelper(ClassLoader mcBootstrapClassLoader, ClassLoader modClassLoader) {
    ...
    public void removeModClassesFromServiceLayer() {
        try {
            ...
            var packageToParentLoaderGetter = unreflectGetter(() -> net.minecraftforge.securemodules.SecureModuleClassLoader.class.getDeclaredField("parentLoaders"));
