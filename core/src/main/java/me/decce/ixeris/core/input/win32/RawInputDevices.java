...
public class RawInputDevices {
    public static final RawInputDevices MOUSE = new RawInputDevices(User32Ex.HID_USAGE_GENERIC_MOUSE, User32Ex.RIDEV_NOLEGACY);
    public static final RawInputDevices KEYBOARD = new RawInputDevices(User32Ex.HID_USAGE_GENERIC_KEYBOARD, User32Ex.RIDEV_NOLEGACY);
